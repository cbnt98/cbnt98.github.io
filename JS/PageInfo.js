...
var pages = [
    ...
    new pageClass(5,"カッコいいベスト買った","2023-12-15","雑記","服はケチらん方が良いかも",5),
    new pageClass(6,"年末年始の過ごし方","2024-1-13","お知らせ","そろそろ部屋片付けんとけん",5),
    new pageClass(7,"何もない午後、ハネムーン","2024-1-25","雑記","みんな～、俺と結婚しよう！！",5),
    new pageClass(8,"ブルーな週末","2024-1-26","雑記","とりあえず寝る",5),
    new pageClass(9,"望んでいること","2024-1-29","雑記","",5),
];
